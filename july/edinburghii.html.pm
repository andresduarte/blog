...
◊span[#:class "mcqueen"]{Edinburgh II}
◊span[#:class "mcduke"]{07.02.17}
...
◊image[#:width "50%" "july2-6.jpg"]
◊margin-note{
  ◊link["https://en.wikipedia.org/wiki/Martin_Creed"]{Martin Creed}
}
◊image[#:width "50%" "july2-7.jpg"]
◊margin-note{
