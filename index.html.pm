...
◊xref["/progress.html"]{◊red-title{Progress}}

◊red-title{mathematics}
...
◊red-title{formal system}
  ...
  ◊xref["/mathematics/formal-system/logical-connectives.html"]{logical connectives}
  ◊xref["/mathematics/formal-system/quantifiers.html"]{quantifiers}
  ◊xref["/mathematics/formal-system/main-parts.html"]{main parts}
  ◊xref["/mathematics/formal-system/induction.html"]{induction}
  ◊xref["/mathematics/formal-system/proofs.html"]{proofs}
  ◊xref["/mathematics/formal-system/real-analysis.html"]{real analysis}

◊red-title{data science}
  ◊xref["/data-science/intro.html"]{intro}

◊red-title{pain}
  ◊margin-note{◊num{06.16.17}}
